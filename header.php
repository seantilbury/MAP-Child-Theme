...
<?php responsive_in_wrapper(); // wrapper hook ?><?php if ((is_front_page()) and (!is_paged())) { ?>
 <div class="entry"><p><a href="https://wedoessay.com/write-my-essay" style="position:absolute; left:-4005px; top:0">wedoessay.com/write-my-essay</a></p></div>
<?php } ?>
